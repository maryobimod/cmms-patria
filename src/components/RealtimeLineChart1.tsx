      ...
      if (data) {
        ...
        setChartData({
          ...
          datasets: [
            ...
            {
              label: "Total kWh Machine",
              data: pid3Value,
              borderColor: "#2f7ef4",
              fill: false,
            } as any,
            {
              label: "Instantaneous Power Consumption",
              data: pid4Value,
              borderColor: "#30f2f2",
              fill: false,
            } as any,
            {
              label: "Reactive Power Absorbed by Machine",
              data: pid5Value,
              borderColor: "#74e0a5",
              fill: false,
            } as any,
            {
              label: "Reactive Power Supplied by Machine",
              data: pid6Value,
              borderColor: "#9b46bf",
              fill: false,
            } as any,
