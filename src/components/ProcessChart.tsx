  ...
  return (
    <div className='flex flex-col justify-center items-center'>
      ...
      <div className='flex items-center gap-2'>
        <div className='flex items-center gap-2'>
          <div className='w-2 h-2 rounded-full bg-[#f7473a]'></div>
          <div className='text-[12px]'>Critical</div>
        </div>
        <div className='flex items-center gap-2'>
          <div className='w-2 h-2 rounded-full bg-[#ffc830]'></div>
          <div className='text-[12px]'>Medium</div>
        </div>
        <div className='flex items-center gap-2'>
          <div className='w-2 h-2 rounded-full bg-[#2f7ef4]'></div>
          <div className='text-[12px]'>Low</div>
        </div>
      </div>
    </div>
  );
