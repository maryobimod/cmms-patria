...
export default function ParameterCategoryChart() {
  return (
    <div className='flex flex-col justify-center items-center'>
      ...
      <div className='flex items-center gap-2'>
        <div className='flex items-center gap-2'>
          ...
          <div className='text-[12px]'>Over Temperature</div>
        </div>
        <div className='flex items-center gap-2'>
          <div className='w-2 h-2 rounded-full bg-[#2f7ef4]'></div>
          <div className='text-[12px]'>Undervoltage</div>
        </div>
      </div>
    </div>
  );
